...
const components: { title: string; href: string; description: string }[] = [
  {
    ...
    description: "Meth video recipe",
  },
  {
    title: "CIA grade blackpowder",
    href: "/videos/blackpowder.mp4",
    description: "Blackpowder video recipe with photos",
  },
  {
    title: "Leaked documents",
    href: "/videos/nato.mp4",
    description: "Allegedly leaked nato documents",
  },
  {
  ...
  },
  {
    ...
    description: "How to make a bomb",
  },
];
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="https://forum.meth.to/" title="Forum">
                Meth Forum
              </ListItem>
            </ul>
          </NavigationMenuContent>
