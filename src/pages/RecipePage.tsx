...
const recipes = {
    1: {
        ...
        steps: [
            ...
            {
                title: "Making methamphetamine out of ephedrine by reducing it with hydroiodic acid and red phosphorus.",
